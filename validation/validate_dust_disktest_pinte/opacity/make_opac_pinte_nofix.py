...
ntheta    = 361           # Number of scattering angle sampling points
#chop      = 1             # Chop off forward scattering and renormalize
chop      = 0             # Chop off forward scattering and renormalize
refinefact = 7.          # The refinement toward the forward and backward scat
...
if refinefact==0.:
    ...
    theta = np.append(angle[0:nang-1],180.-angle[::-1])
