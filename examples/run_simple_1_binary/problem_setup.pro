...
;
openw,1,'dust_density.binp'
idum=1LL
writeu,1,idum                   ; Format number
idum=8LL
writeu,1,idum                   ; 4=single precision, 8=double precision
idum=1LL*(nx*ny*nz)
writeu,1,idum                   ; Nr of cells
idum=1LL
writeu,1,idum                   ; Nr of dust species
for iz=0,nz-1 do begin
   for iy=0,ny-1 do begin
      for ix=0,nx-1 do begin
         dum = 1.d0*rhod[ix,iy,iz]
         writeu,1,dum
      endfor
   endfor
endfor
...
printf,1,'rto_style = 3'   ;; Binary output style 
close,1
;
end
