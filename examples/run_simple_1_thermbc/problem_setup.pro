...
printf,1,'thermal_boundary_xl = 100.'  ; Comment out any of these BCs as experiment
printf,1,'thermal_boundary_xr = 100.'  ; With all 6 switched on, the dust temperature
printf,1,'thermal_boundary_yl = 100.'  ; must become constant at 100 K.
printf,1,'thermal_boundary_yr = 100.'
printf,1,'thermal_boundary_zl = 100.'
printf,1,'thermal_boundary_zr = 100.'
close,1
;
end
