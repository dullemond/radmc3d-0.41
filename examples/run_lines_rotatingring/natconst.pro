...
mole= 6.02214129d23  ; 1 Mole (Avogadro's constant) = 1/mu
;                                                              
;     Alternative units                                        
;                                                              
ev  = 1.6022d-12     ; Electronvolt            [erg]
kev = 1.6022d-9      ; Kilo electronvolt       [erg]
micr= 1.d-4          ; Micron                  [cm]
km  = 1.d5           ; Kilometer               [cm]
angs= 1.d-8          ; Angstroem               [cm]
;                                                              
;     Astronomy constants                                      
;                                                              
...
mea = 5.9736d27      ; Mass of Earth           [g]
rea = 6.375d08       ; Equatorial radius Earth [cm]
mmo = 7.347d25       ; Mass of moon            [g]
rmo = 1.738d08       ; Radius of moon          [cm]
dmo = 3.844d10       ; Distance earth-moon (center-to-center)  [cm]
mju = 1.899d30       ; Mass of Jupiter         [g]
rju = 7.1492d9       ; Equat. radius Jupiter   [rm]
dju = 7.78412d13     ; Distance Jupiter-Sun    [cm]
;                                                              
;     Time units                                               
;                                                              
;year= 3.1536d7       ; Year                    [s]
year= 31557600.d0    ; Year                    [s]
