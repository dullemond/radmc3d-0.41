...
plt.plot(opacsingle["lamcm"]*1e4,opacsingle["kscat"],label='Scattering (no smear)')
...
inu = 50
ll  = lamcm[inu]*1e4
plt.plot(opac["theta"],opac["zscat"][inu,:,0],label='With smearing')
plt.plot(opacsingle["theta"],opacsingle["zscat"][inu,:,0],label='No smearing')
